    ...
    return allCompanies.stream()
        .map(
            company -> {
              ...
              MenuElement companyElement =
                  new MenuElement(company.getId(), company.getName(), null);
              companyElement.setOnSelect(
                  request -> {
